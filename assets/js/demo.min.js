...
!function (e) {
    ...
    function t(n) {
        var o = e(n), a = e(".widget select");
        o.length && o.select2({width: "100%"}), a.length && a.select2({width: "100%"})
    }
    ...
    function i(n) {
        ...
        o.length && o.find(".js-slick-slider").slick({
            ...
            responsive: [{breakpoint: 1100, settings: {slidesToShow: 4}}, {
                breakpoint: 1e3,
    ...
    function l(n) {
        ...
        var a = e(n);
        if (a.length) {
            var t = a.find(".js-search-form"), i = e(".header"), s = e("#header-nav"), r = a.find(".map");
    ...
    function c(n) {
        if (e("#banner-line").length) {
            var o = e(n), a = o.find(".js-search-form");
            new app.Vivus("banner-line", {
                ...
                n.hasClass("slick-slide") && !n.hasClass("slick-active") || (o.find(".js-arrow-end").css({opacity: 1}), a.addClass("form--anim"))
            })
        }
    }
    ...
    function p(n) {
        ...
        if (o.length) {
            ...
            a.slick({
                ...
                responsive: [{breakpoint: 1300, settings: {centerMode: !1, variableWidth: !1, arrows: !0}}]
    ...
    function d(n) {
        if ("xs" !== app.gridSize.get()) {
            var o = e(n), a = o.find(".js-slick-slider");
            a.slick({
                dots: !0,
                infinite: !0,
                autoplay: !0,
    ...
    function g(n) {
        ...
        if (o.length) {
            var a, t;
            o.each(function () {
                var n = e(this), o = n.find(".js-slick-slider"), i = n.siblings(".slider");
    ...
    function f(n) {
        ...
        var a = e(n), t = a.find(".js-select-checkboxes"), i = a.find(".js-select-checkboxes"),
            s = a.find(".js-search-range"), r = a.find('input[type="text"]'), l = a.find("textarea"),
            c = a.find("select"), p = a.find('input[type="checkbox"]');
        t.each(function () {
            var n = e(this), o = e(this).prev(".js-select-checkboxes-btn"), a = o.data("placeholder");
            ...
            var n = e(this), o = n.closest(".js-select-checkboxes");
            ...
            }), p.prop({checked: !1, indeterminate: !1}), i.each(function (n, o) {
    ...
    function m() {
        var n = e("#range_area"), o = e("#range_price"), a = e("#range_commision"), t = e("#range_room"),
            i = e("#range_ui");
    ...
    function u(n) {
        ...
        o.length && o.each(function () {
            var n = e(this), o = n.find(".js-slick-current"), a = n.find(".js-slick-total");
    ...
    function h(n, o) {
        var a = e(n);
        a.length && !function () {
            var n = new google.maps.LatLng(o.lat, o.lng), t = e(".js-map-btn");
            app.createMap(a, t, function () {
                var e = new google.maps.Map(a[0], _.merge(T, {zoom: 16, coordinates: n}));
    ...
    function v(n) {
        ...
        o.length && o.on("click", function () {
            var n = e(this), o = n.data("state") || "success";
    ...
    function k(n, o, a) {
        var t = e(n), i = e(o);
        if (t.length && i) {
            var s, r = new google.maps.LatLng(a.lat, a.lng), l = e(".js-map-btn"), c = e(".js-panorama-btn");
            app.createMap(t, l, function () {
                var e = new google.maps.Map(t[0], _.merge(T, {zoom: 16, coordinates: r})), n = C(a);
            ...
            l.on("click", function () {
                "xs" !== app.gridSize.get() && (p(this), i.css({zIndex: 5}), t.css({zIndex: 10}))
            }), c.on("click", function () {
                "xs" !== app.gridSize.get() && (p(this), i.css({zIndex: 10}), t.css({zIndex: 5}))
            })
        }
    }
            ...
            o.each(function () {
                e(this).parsley().on("form:success", function (e) {
                    ...
                    return app.notifier.showError("Submited failed! Please try again."), _.each(a, function (n) {
                        var o, a = e(n).find(".parsley-required"), t = e(n).attr("id");
    ...
    function j(n, o) {
        var a = e(n);
        if (a.length) {
            var t = e(".js-map-btn"), i = a.find(".js-map");
            app.createMap(i, t, function () {
                ...
                function o(e) {
                    d.geocode({latLng: e}, function (e, n) {
                ...
                var c, p, d, g = a.find(".js-autocomplete"), f = a.find(".js-location-coords"),
                    m = a.find(".js-remove-overlays"), u = !1;
                d = new google.maps.Geocoder, c = new google.maps.Map(i[0], T), google.maps.event.addListener(c, "click", function (e) {
                    ...
                    buttonTrigger: a.find(".js-geolocate"), onSuccess: function (e) {
                        n(e)
                    }
                });
    ...
    function x(n, o) {
        var a = e(n);
        if (a.length) {
            var t, i = new L.LatLng(22.3806266, 88.26989), s = !1;
            app.createMap(a, e(".js-map-btn"), function () {
                if (s) t.invalidateSize(); else {
                    t = L.map(a[0], _.merge({
                        zoom: 16,
                        center: i,
                        zoomControl: !1,
                    ...
                    var e = L.control.zoom({position: "topright"});
    ...
    function C(e) {
        var n;
        return n = "assets/media-demo/properties/277x180/" + e.image + ".jpg", "<span class='map__address'>" + e.address + "</span> <span class='map__info'><img  class='map__photo' src='" + n + "'/><span class='map__details'> <dl><dt>Type:</dt> <dd>" + e.type + "</dd></dl><dl><dt>Area:</dt> <dd>" + e.area + " m2</dd></dl><dl><dt>Bedrooms:</dt> <dd>" + e.bedrooms + "</dd></dl></span></span> <span class='map__price'><strong>$" + e.price + "</strong></span> <a  class='map__more' href='property_details.html'>Details</a>"
    }

    app.initTheme({
        colorTheme: "default",
        loadSvgWithAjax: !1
    }), app.activateHeaderSpy(), app.activateScrollToTopSpy(), app.scrollAnimation();
    var T = {
        zoom: 16,
        center: new google.maps.LatLng(22.3806266, 88.26989),
        scrollwheel: !1,
        zoomControl: !1,
        mapTypeControl: !1,
    ...
    s(".player"), i("#partners-slider"), t("select.form-control"), a(".js-gallery-item"), o(".js-contact-form"), n(".js-subscribe-form"), r("#review-slider"), l(".js-banner"), p("#slider-wide"), d(".js-banner-slider"), g(".js-slider-thumbs"), b(".js-map-index-canvas", window.demodata), b(".js-map-canvas-fullscreen", window.demodata), k('.js-map-canvas[data-type="map"]', '.js-map-canvas[data-type="panorama"]', window.demodata[3]), w(".js-form"), m(), u(".js-slick-blog"), u(".js-slick-plan"), u("#counter-slider"), u("#properties-banner"), h(".js-map-canvas-contact", window.demodata[3]), v(".js-btn-demo"), y(".js-popover"), j(".js-map-location-dashboard-submit", {
        lat: 22.3806266,
        lng: 88.26989
