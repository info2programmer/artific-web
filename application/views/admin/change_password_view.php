					...
					<div class="portlet box green">
						<div class="portlet-title">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form method="post" action="<?php echo base_url() ?>admin/update_password/"  class="form-horizontal form-bordered">
									...
									<div class="form-body">
										<div class="form-group last">
											...
											<div class="col-md-10">
												<input type="password" name="txtReEnterPassword" class="form-control" placeholder="Re-Enter Password" required>
											</div>
										</div>
									</div>
