...
<?php endif; ?>
	...
	<a href="<?php echo base_url() ?>product/product_manage" class="btn btn-success">Not in List?</a>

<div class="portlet">
<div class="portlet-title">
<div class="caption">
<i class="fa fa-bell-o"></i>Product List </div>
<div class="tools">
...
<th class="hidden-xs"> Product Tag </th>
<th class="hidden-xs"> Product Price </th>
<th class="hidden-xs"> Product Icon </th>
<th class="hidden-xs"> Modify At </th>
<th>Action</th>
</tr>
</thead>
<tbody>
...
<td><?php echo $item->product_tag ?></td>
<td><?php echo $item->product_price ?></td>
<td><?php echo $item->product_icon ?></td>
<td><?php echo $item->create_at ?></td>
<td>
	<a onclick="return confirm('Are you sure?');" href="<?php echo base_url() ?>product/delete_product/<?php echo $item->id ?>" class="btn btn-outline btn-circle dark btn-sm black">
		<i class="fa fa-trash-o"></i> Delete </a>
	<?php if($item->product_status): ?>
	<a onclick="return confirm('Are you sure?');" href="<?php echo base_url() ?>product/status_change/<?php echo $item->id ?>/0/" class="btn btn-outline btn-circle dark btn-sm red">
		<i class="fa fa-times"></i> Deactive Now </a>
	<?php else: ?>
	<a onclick="return confirm('Are you sure?');" href="<?php echo base_url() ?>product/status_change/<?php echo $item->id ?>/1/" class="btn btn-outline btn-circle dark btn-sm green">
