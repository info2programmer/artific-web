...
<?php endif; ?>
	...
	<a href="<?php echo base_url() ?>blog/blog_manage" class="btn btn-success">Not in List?</a>

<div class="portlet">
<div class="portlet-title">
<div class="caption">
<i class="fa fa-bell-o"></i>Blog List </div>
<div class="tools">
...
<thead>
<tr>
<th><i class="fa fa-briefcase"></i> Blog Title </th>
<th class="hidden-xs"><i class="fa fa-user"></i> Date Time </th>
<th>Action</th>
<th>Status</th>
</tr>
</thead>
...
<td>
	<a onclick="return confirm('Are you sure?');" href="<?php echo base_url() ?>blog/delete_blog/<?php echo $item['blog_id'] ?>" class="btn btn-outline btn-circle dark btn-sm black">
		<i class="fa fa-trash-o"></i> Delete </a>
	<?php if(!$this->session->userdata('type')): ?>

		<?php if(!$item['aprove_status']): ?>
			<a onclick="return confirm('Are you sure?');" href="<?php echo base_url() ?>blog/aprove_blog/<?php echo $item['blog_id'] ?>/1/" class="btn btn-outline btn-circle dark btn-sm green">
			<i class="fa fa-thumbs-o-up"></i> Aprove Blog Now </a>
		<?php else: ?>
			<label class="lable label-danger">Approve By - <?php $aprove_result = $this->admin_model->get_all_records('tbl_adminlogin','admin_id',$item['aprove_by']); echo $aprove_result[0]['name'] ?></label>
		<?php endif; ?>

		<a onclick="return confirm('Are you sure?');" href="<?php echo base_url() ?>blog/edit_blog/<?php echo $item['blog_id'] ?>" class="btn btn-outline btn-circle dark btn-sm yellow">
		<i class="fa fa-eye"></i> View Full Blog </a>
	<?php endif ?>
	<?php if($item['status']): ?>
			<a onclick="return confirm('Are you sure?');" href="<?php echo base_url() ?>blog/change_status/<?php echo $item['blog_id'] ?>/0/" class="btn btn-outline btn-circle dark btn-sm red">
			<i class="fa fa-unlock-alt"></i> Deactive Now </a>
		<?php else: ?>
			<a onclick="return confirm('Are you sure?');" href="<?php echo base_url() ?>blog/change_status/<?php echo $item['blog_id'] ?>/1/" class="btn btn-outline btn-circle dark btn-sm blue">
			<i class="fa-unlock"></i> Active Now </a>
	<?php endif ?>
</td>
<td>
	<?php if($item['aprove_status']): ?>
