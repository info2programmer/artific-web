...
<?php endif; ?>
	...
	<a href="<?php echo base_url() ?>admin/create_user" class="btn btn-success">Not in List?</a>

<div class="portlet">
<div class="portlet-title">
<div class="caption">
<i class="fa fa-bell-o"></i>User List </div>
<div class="tools">
...
<td><img src="<?php echo base_url() ?>assets/layouts/layout3/img/<?php echo $item->image ?>" style="height:41px;width:41px;"></td>
<td><?php echo $item->type = 0 ? 'Blogger' : 'Admin' ?></td>
<td>
	<a onclick="return confirm('Are you sure?');" href="<?php echo base_url() ?>admin/delete_user/<?php echo $item->admin_id ?>/<?php echo $item->image ?>" class="btn btn-outline btn-circle dark btn-sm black">
		<i class="fa fa-trash-o"></i> Delete </a>
	<?php if($item->status): ?>
	<a onclick="return confirm('Are you sure?');" href="<?php echo base_url() ?>admin/status_change_user/<?php echo $item->admin_id ?>/0/" class="btn btn-outline btn-circle dark btn-sm red">
		<i class="fa fa-times"></i> Deactive Now </a>
	<?php else: ?>
	<a onclick="return confirm('Are you sure?');" href="<?php echo base_url() ?>admin/status_change_user/<?php echo $item->admin_id ?>/1/" class="btn btn-outline btn-circle dark btn-sm green">
