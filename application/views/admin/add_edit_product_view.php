...
<li>
<a href="<?php echo base_url() ?>product/">Manage Product</a>
<i class="fa fa-circle"></i>
</li>
<li>
...
<div class="caption">
<i class="fa fa-gift"></i>Create Product </div>
<div class="tools">
...
<div class="col-md-10">
	<input type="text" name="txtProductName" id="txtProductName" value="" class="form-control" required placeholder="Enter Product Name Here">
</div>
</div>
</div>
...
<div class="form-body">
<div class="form-group last">
<label class="control-label col-md-2">Product Tag</label>
<div class="col-md-10">
	<input type="text" name="txtProductTag" id="txtProductTag" value="" class="form-control" required placeholder="Enter Product Tag With (,)Comma">
</div>
</div>
</div>
...
<div class="form-body">
<div class="form-group last">
<label class="control-label col-md-2">Product Price Range</label>
<div class="col-md-10">
	<input type="text" name="txtProductPrice" id="txtProductPrice" value="" class="form-control" required placeholder="Enter Product Price Renge">
</div>
</div>
</div>
...
<div class="form-body">
<div class="form-group last">
<label class="control-label col-md-2">Product icon</label>
<div class="col-md-10">
	<input type="text" name="txtProductIcon" id="txtProductIcon" value="" class="form-control" required placeholder="Enter Product Icon">
</div>
</div>
</div>
...
<div class="col-md-10">
	<textarea class="form-control" name="txtDescription" required placeholder="Product Description"></textarea>
</div>
</div>
</div>
<br>
