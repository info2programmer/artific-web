...
<li>
<a href="<?php echo base_url() ?>blog/blog_category/">Manage Blog Category</a>
<i class="fa fa-circle"></i>
</li>
<li>
...
<div class="caption">
<i class="fa fa-gift"></i>Create Blog Category </div>
<div class="tools">
...
<div class="col-md-10">
	<input type="text" name="txtCategory" id="txtCategory" value="" class="form-control" required placeholder="Enter Category Name Here">
</div>
</div>
</div>
