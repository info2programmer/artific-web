            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="footer-box fl-wrap">
                        ...
                        <a href="https://twitter.com/werartific" class="btn float-btn trsp-btn">Follow</a>
                    </div>
                </div>
                <div class="col-md-5">
                    ...
                    <!-- footer-box-->
                    <div class="footer-box fl-wrap">
                        <p>Drop your email we will contact you</p>
                        ...
                        <div class="footer-contacts fl-wrap">
                            <ul>
                                <li><i class="fal fa-phone"></i><span>Phone :</span><a href="#">+91 78901 86137</a></li>
                                <li><i class="fal fa-envelope"></i><span>Email :</span><a href="mailto:artific.reach@gmail.com">artific.reach@gmail.com</a></li>
                        ...
                        <div class="footer-socilal fl-wrap">
                            <ul>
                                <li><a href="https://www.facebook.com/artificit" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="https://www.instagram.com/artific_online/" target="_blank"><i class="fab fa-instagram"></i></a></li>
                                <li><a href="https://twitter.com/werartific" target="_blank"><i class="fab fa-twitter"></i></a></li>
    ...
    <div class="subfooter fl-wrap">
        <div class="container">
            ...
            <div class="policy-box">
                <span>&#169; ARTIFIC <?php echo date('Y') ?> / All rights reserved. </span>
            </div>
            <!-- policy-box end-->
